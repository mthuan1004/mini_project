        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="flex flex-col">
            ...
            <p className="text-gray-600 font-semibold mt-4">
              Our company specializes in providing all types of clean,
              high-quality rice.
            </p>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <ul className="flex flex-col space-y-2 text-gray-600">
              ...
              <li>
                Address: <br /> Cong Hoa Garden, 20 Cong Hoa, Tan Binh, Ho Chi
                Minh City. <br /> Ward 5, City. Tan An, Long An province
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col">
            <h3 className="text-green-600 font-bold mb-4">Follow Us</h3>
